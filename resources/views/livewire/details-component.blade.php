                ...
                <div class="detail-info">
                    ...
                    @if($product->sale_price >0 )
                        <div class="wrap-price">
                            ...
                            <del><p class="product-price" style="font-size:13px !important;padding-left:10px;">৳{{$product->regular_price}}</p></del>
                        </div>
                    @else
                    ...
                    <div class="wrap-butons">
                        <a href="#" class="btn add-to-cart" wire:click.prevent="stores({{$product->id}},'{{$product->name}}',{{$product->regular_price}})">Add to Cart</a>
                        <div class="wrap-btn">
                                    ...
                                    <ol class="commentlist">
                                        <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-20">
                                            <div id="comment-20" class="comment_container"> 
                                                <img alt="" src="{{ asset('assets/images/auspice_1.jpg')}}" height="80" width="80">
                        ...
                        <li class="product-item">
                            <div class="product product-widget-style">
                                ...
                                <div class="product-info">
                                    <a href="{{route('product.details',['slug'=>$p_product->slug])}}" title="{{$p_product->name}}"><span>{{$p_product->name}}</span></a>
