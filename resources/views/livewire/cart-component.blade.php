			...
			<div class=" main-content-area">
				...
				<div class="summary">
					<div class="order-summary">
						...
						<p class="summary-info"><span class="title">Sutotal with discount</span><b class="index">৳{{number_format($subtotalAfterDiscount,2)}}</b></p>
							...
							@if($haveCouponCode==1)
								<div class="summary-item">
									<form wire:submit.prevent="applyCouponCode">
										...
										@endif
										<p class="row-in-form">
											<label for="coupon-code">Entter your code:</label>
