		...
		<div class="container">
			...
			<div class="wrap-breadcrumb">
				<ul>
					...
					<li class="item-link"><span>Spices and Dry Fruits</span></li>
				</ul>
			</div>
			<div class="row">
				...
				<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
					...
					<div class="wrap-shop-control">
						...
						<h1 class="shop-title">Spices and Dry Fruits</h1>
						...
						<div class="widget-content">
							<ul class="list-category">
								<li class="category-item has-child-cate">
									<a href="#" class="cate-link">By Family</a>
									<span class="toggle-control">+</span>
									<ul class="sub-cate">
										<li class="category-item"><a href="#" class="cate-link">Essential (22)</a></li>
										<li class="category-item"><a href="#" class="cate-link">Chilies (16)</a></li>
										<li class="category-item"><a href="#" class="cate-link">Baking (28)</a></li>
									</ul>
								</li>
								<li class="category-item has-child-cate">
									<a href="#" class="cate-link">By Specialty</a>
									<span class="toggle-control">+</span>
									<ul class="sub-cate">
										<li class="category-item"><a href="#" class="cate-link">Best Sellers</a></li>
										<li class="category-item"><a href="#" class="cate-link">Cinnamon</a></li>
										<li class="category-item"><a href="#" class="cate-link">Curry</a></li>
									</ul>
								</li>
								<li class="category-item has-child-cate">
									<a href="#" class="cate-link">By Region</a>
									<span class="toggle-control">+</span>
									<ul class="sub-cate">
										<li class="category-item"><a href="#" class="cate-link">Bangladesh</a></li>
										<li class="category-item"><a href="#" class="cate-link">India</a></li>
										<li class="category-item"><a href="#" class="cate-link">Pakistan</a></li>
									</ul>
								</li>
								<li class="category-item">
									<a href="#" class="cate-link">Baking</a>
								</li>
								<li class="category-item">
									<a href="#" class="cate-link">Organic</a>
								</li>
								<li class="category-item">
									<a href="#" class="cate-link">View all Spices</a>
								</li>
							</ul>
						</div>
